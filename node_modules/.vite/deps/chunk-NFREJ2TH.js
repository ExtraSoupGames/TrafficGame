...
import {
  BaseTexture,
  Texture
} from "./chunk-OVSFBSMC.js";
import {
  SerializationHelper
} from "./chunk-JOYONEPX.js";
import {
  Color3
} from "./chunk-YWVI35XL.js";
import {
  __decorate,
  serialize,
  serializeAsColor4
} from "./chunk-ETNI5RZI.js";
import {
  Matrix,
  TmpVectors,
  ToLinearSpace,
  ...
  Vector3,
  _ObserveArray
} from "./chunk-KYHLAP3G.js";
import {
  HasStencilAspect,
  ThinEngine,
  WebGLDataBuffer,
  WebGLHardwareTexture
} from "./chunk-MRLCOEXG.js";
import {
  EffectWrapper
} from "./chunk-5JOJQ3JH.js";
import {
  GetClass,
  RegisterClass
...
var RenderTargetTexture = class _RenderTargetTexture extends Texture {
  ...
  isReadyForRendering() {
    if (!this._dumpToolsLoading) {
      ...
      import("./dumpTools-OYRUESFD.js").then((module) => this._dumpTools = module);
    }
...
ThinEngine.prototype.createPrefilteredCubeTexture = function(rootUrl, scene, lodScale, lodOffset, onLoad = null, onError = null, format, forcedExtension = null, createPolynomials = true) {
  const callbackAsync = async (loadData) => {
    ...
    const { DDSTools } = await import("./dds-FOHFJPTI.js");
    const textures = [];
...
//# sourceMappingURL=chunk-NFREJ2TH.js.map
